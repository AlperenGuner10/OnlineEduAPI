...
namespace OnlineEdu.API.Controllers
{
	...
	{
		private readonly IGenericService<TeacherSocial> _teacherSocialService;
		private readonly IMapper _mapper;

		public TeacherSocialsController(IGenericService<TeacherSocial> teacherSocialService, IMapper mapper)
		{
			_teacherSocialService=teacherSocialService;
			_mapper=mapper;
		}
		[AllowAnonymous]
		...
		public IActionResult Create(CreateTeacherSocialDto createTeacherSocialDto)
		{
			...
			_teacherSocialService.TCreate(value);
